...
<div class="fright">
版主: <script>writeBMs('<?php echo $brdarr["BM"]; /* No addslashes! */ ?>');</script>, 在线 <?php echo $brdarr["CURRENTUSERS"]; ?> 人, <span title='<?php echo "发生于 ".strftime("%Y-%m-%d %H:%M:%S", $brdarr["MAXTIME"]);?>'>最高 <?php echo $brdarr["MAXONLINE"]; ?> 人</span>
</div>
</div>
